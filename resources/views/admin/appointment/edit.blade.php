             ...
             <div class="row">
                           <div class="col-md-6">
                             <div class="form-group">
                                 ...
                                 <input type="text" name="user_id" class="form-control" value="{{ $appointment->patient_id }}">
                             </div>
                         </div>
                           <div class="col-md-6">
                             <div class="form-group">
                                 <label for="">Nom Patient</label>
                                 <input type="text" name="user_name" class="form-control"   value="{{ $appointment->patient_name }}">
                             </div>
                         </div>
                         ...
                         <div class="col-md-6">
                             <div class="form-group">
                                 <label for="">Identifiant de Médcin</label>
                                  <input type="text" name="doctor_id" class="form-control" value="{{ $appointment->doctor_id }}">
                             </div>
                         </div>
                         ...
                         <div class="col-md-6">
                             <div class="form-group">
                                 <label for="">Heure du Rendez-vous</label>
                                  <input type="text" name="appointment_time" class="form-control" value="{{ $appointment->appointment_time }}" >
                         ...
                         <div class="col-md-6">
                             <div class="form-group">
                                 <label for="">Date du Rendez-vous</label>
                                  <input type="text" name="appointment_date" class="form-control"  value="{{ $appointment->appointment_date }}">
                             </div>
                         </div>
