   ...
   <div class="container " style="margin-top: 150px ; margin-left:10px;">
     ...
     <div class="row">
        ...
        <div class="card">
          ...
          <a href="#"  class="btn float-right mb-5" style="border-color: #C96567 ; background-color:#C96567;"></a>
       ...
       <div class="responsive-container" >
            ...
            <table class="table table-striped table-bordered">
                <thead>
                    ...
                    <th style="width:50px">Médecin n°</th>
  ...
  <tr>
    ...
    <td>{{ $item->description }}</td>
     ...
     <td> {{ $item->app_time }}</td>
      ...
      <td>
         <a href="{{ url('appointment-edit/'.$item->id )}}" class="badge badge-pill  px-3 py-2" style="background-color: #C96567; text-decoration:none ">Modifier</a>
        <a href="{{  url ('appointment-delete/'.$item->id) }}" class="badge badge-pill  px-3 py-2" style="background-color: #97AABD ; text-decoration:none">Supprimer</a>
      </td>
</tr>
  @endforeach
 </tbody>
