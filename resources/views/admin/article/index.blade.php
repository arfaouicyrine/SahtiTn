     ...
     <!-- Heading -->
      <div class="card mb-4 wow fadeIn">
        ...
        <div class="card-body d-sm-flex justify-content-between">
          ...
          <a href="{{ url('add-article') }}" class="btn  float-right" style="border-color:#C96567 ; background-color: #C96567;">Ajouter un article</a>
          ...
          <div class="col-md-12">
             <div class="card">
                ...
                <tbody>
                    ...
                    <td><img src="{{ asset('uploads/articles/' .$item->image)}}" alt="Article Image" width="60px"></td>
                     <td>{{ $item->is_featured}}</td>

                        <td>
                          <a href="{{ url('edit-article/'.$item->id) }}"  class="badge badge-pill  px-3 py-2" style="background-color: #C96567; text-decoration:none ">Modfier</a>
                          <a href="{{ url('article-delete/'. $item->id) }}" class="badge badge-pill  px-3 py-2" style="background-color: #97AABD ; text-decoration:none">Supprimer</a>
                         </td>
