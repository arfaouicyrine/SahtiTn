...
<body>
   ...
   <div class="sidebar">
     <div class="sidebar-brand">
         <h2> <span><img src="https://img.icons8.com/dusk/64/000000/doctors-bag.png"/></span> <a style="text-decoration: none ; color:whitesmoke ;" href="{{ url('/') }}">SaHtI</a></h2>
     </div>
         ...
         <div class="col-md-12">
            <div class="card">
                  @if (session('status'))
                    ...
                    @endif
                <div class="card-body">
                    <form action="{{ url('location-update/'.$locations->id) }}" method="POST">
                       {{ csrf_field() }}
                        {{ method_field('PUT') }}
                       <div class="row">
                           <div class="col-md-12">
                             <div class="form-group">
                                 ...
                                 <input type="text" name="title" value="{{ $locations->title }}" class="form-control" placeholder="Entrer un nom">
                             </div>
                         </div>
