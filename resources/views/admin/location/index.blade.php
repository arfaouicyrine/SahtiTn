      ...
      <div class="card mb-4 wow fadeIn">
        ...
        <div class="card-body d-sm-flex justify-content-between">
          ...
          <h4 class="mb-2 mb-sm-0 pt-1">
            <span style="background-color: ">Etat</span>
          </h4>
          <a href="{{ url('location-add') }}" class="btn  float-right" style="border-color:#C96567 ; background-color: #C96567;">Ajouter une gouvernerat</a>
          ...
          <div class="col-md-12">
             <div class="card">
                ...
                <tbody>
                    ...
                    <td>
                        <a href="{{ url('location-edit/'.$item->id )}}"  class="badge badge-large  px-3 py-2" style="background-color: #C96567; text-decoration:none ">Edit</a>
