                       ...
                       <div class="row">
                         ...
                         <div class="col-md-12">
                             <div class="form-group">
                                 ...
                                 <textarea rows="4" name="description" class="form-control" placeholder="Tapez une description"> {{ $department->description }}</textarea>
                             </div>
                         </div>

                          <div class="col-md-12 mt-3">
                             <div class="form-group">
                              <button type="submit" class="btn" style="border-color:#97AABD ; background-color: #97AABD; margin-left:400px ;">
                                Modifier
                              </button>
                             </div>
                         </div>
