...
<body>
   ...
   <div class="sidebar">
     <div class="sidebar-brand">
         <h2> <span><img src="https://img.icons8.com/dusk/64/000000/doctors-bag.png"/></span> <a href="{{ url('/') }}" style="text-decoration: none ; color:whitesmoke ;"></a></h2>
     </div>
                    ...
                    <form action="{{ url('doctor-store') }}" method="POST" enctype="multipart/form-data">
                       ...
                       <div class="col-md-6">
                             <div class="form-group">
                                 ...
                                 <textarea rows="4" name="educations" class="form-control" placeholder="Tapez une description"> </textarea>
                             </div>
                         </div>
                           <!-- end education -->
                             <!-- department -->
