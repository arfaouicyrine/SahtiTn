     ...
     <!-- Heading -->
      <div class="card mb-4 wow fadeIn">
        ...
        <div class="card-body d-sm-flex justify-content-between">
          ...
          <a href="{{  url('hospital-add') }}" class="btn  float-right" style="border-color:#C96567 ; background-color: #C96567;" >Ajouter un Hôpital </a>
                       ...
                       <tbody>
                           ...
                           <tr>
                               <td>{{ $item->id }}</td>
                                ...
                                <td>
                                     <img src="{{ asset('uploads/hospital/' .$item->image) }}" width="50px" alt="">
                                 </td>
                                ...
                                <td>
                                 <a href="{{ url('/hospital-edit/'.$item->id )}}" class="badge badge-pill  px-3 py-2" style="background-color: #C96567; text-decoration:none ">Edit</a>
                                    <a href="{{ url('hospital-delete/'.$item->id) }}" class="badge badge-pill  px-3 py-2" style="background-color: #97AABD ; text-decoration:none">Delete</a>
                                </td>
                           </tr>
